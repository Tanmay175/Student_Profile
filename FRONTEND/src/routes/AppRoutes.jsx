...
import SendNotification from "../pages/professor/SendNotification";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/student/*" element={
          <ProtectedRoute role="student"><Layout role="student" /></ProtectedRoute>
        }>
        ...
        <Route path="/professor/*" element={
          <ProtectedRoute role="professor"><Layout role="professor" /></ProtectedRoute>
        }>
